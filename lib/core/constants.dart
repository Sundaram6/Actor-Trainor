...
const List<BlockConfig> kRoutineBlocks = [
  ...
  BlockConfig(
    ...
    durationMinutes: 10,
    tag: 'CONTINUITY',
    description: 'Maintain an unbroken stream of inner life. Three stages: free association, dual awareness, and character entry. Speak aloud. Do not perform — think.',
    subSteps: [
      SubStep(
        title: 'Stream of Consciousness',
        instruction: 'Speak every thought that crosses your mind. No censorship. No shaping for an audience. If you go blank, say "I am blank" until the next thought arrives. Do not judge the content. The goal is flow, not poetry.',
        durationSeconds: 180,
      ),
      SubStep(
        title: 'Dual Awareness',
        instruction: 'Continue the inner monologue aloud while performing a simple physical action: tie a shoe, wash your hands, or fold a piece of paper. The thought and the action must coexist. Do not let the task kill the thought. Do not let the thought stop the task.',
        durationSeconds: 180,
      ),
      SubStep(
        title: 'Character Entry',
        instruction: 'Switch to your character\'s inner monologue. Speak their unspoken thoughts about the scene — not the lines, not the blocking, just the raw internal life. What do they want right now? What are they afraid the other person will discover? Stay inside it. Do not perform.',
        durationSeconds: 240,
      ),
    ],
  ),
